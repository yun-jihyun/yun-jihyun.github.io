...
> **Note**: Enrollment growth shows how much the loyalty program is expanding, but the raw number alone is not enough. What matters is whether these new members actually engage with our properties. Tracking MBV Occupancy reflects the **quality of enrollments** by showing how many of these enrolled members contribute to generating actual room revenue. 
...
##### Implementation 
  ...
  - i) Create a **dummy calendar table** with 6 columns: day, week, month, quarter, year, and no time breakdown. 
...
> **Note**: Keep in mind to begin week counting from Sunday. 
  ...
  - ii) Create a **field parameter** to allow users to switch the time period dynamically. 
...
This involved 3 steps:
  ...
  - **i) Capture the Selected Time Period**
 ...
 ```
  ...
  - **ii) Calculate Metrics for Current and Previous Periods**
  ...
  - **iii) Calculate Period-on-Period Growth** 
